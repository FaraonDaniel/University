...
class Form
{
  ...
  {
    if ( ! isset($_SESSION) ) {
      throw new Exception('La sesion del usuario no esta definida.');
    }
  ...
  {
    if ( ! isset($_SESSION) ) {
      throw new Exception('La sesiÃ³n del usuario no esta definida.');
    }
